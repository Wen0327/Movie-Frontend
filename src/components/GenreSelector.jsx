...
export default function GenreSelector({ badge, onClick }) {
  const renderBadge = () => {
  ...
  return (
    <button
     ...
     hover:border-primary transition dark:text-dark-subtle dark:hover:text-white hover:text-primary rounded "
    >
      <ImTree />
